...
const e2oExport = {
	...
	packager: {
		createInstaller: deploy.createInstaller,
		createPackage: deploy.createPackage,
		createFullInstaller: deploy.createFullInstaller,
		setManifestURL: deploy.setManifestURL
	},
	// This is used when actually creating an e2o application. It is our main wrapper around electron
	e2oApplication: (app, manifest) => {
		try {
			const e2o = require('./src/main/Main');
