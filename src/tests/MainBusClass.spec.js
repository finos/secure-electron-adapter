...
// Fake applicationManager's findWindowByName
process.applicationManager = {
...
describe('MainBus.js', () => {
    ...
    describe('Instantiation', () => {
        ...
        it('Registers e2o.mainRequest handler', () => {
            assert.exists(_events['e2o.mainRequest'])
        })
        ...
        it('Registers e2o.subscribe handler', () => {
            assert.exists(_events['e2o.subscribe'])
        })
        it('Registers e2o.unSubscribe handler', () => {
            assert.exists(_events['e2o.unSubscribe'])
        })
        it('Registers e2o.publish handler', () => {
            assert.exists(_events['e2o.publish'])
        })
        spy1.restore()
        spy2.restore()
    })
